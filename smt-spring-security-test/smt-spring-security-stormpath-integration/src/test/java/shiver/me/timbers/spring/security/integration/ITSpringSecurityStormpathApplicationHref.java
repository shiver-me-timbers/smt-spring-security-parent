...
@SpringApplicationConfiguration(classes = StormpathApplicationHrefConfiguration.class)
@WebIntegrationTest
@DirtiesContext
public class ITSpringSecurityStormpathApplicationHref {
    ...
    public void Can_sign_in_using_stormpath() throws IOException {
        ...
        mockStormpath.mockApplication(baseUrl, applicationId);
        ...
        // Then
        mockStormpath.verifyApplication(applicationId);
    ...
    private String applicationId() {
        final String[] hrefParts = applicationHref.split("/");
